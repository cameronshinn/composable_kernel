...
#include "ck/tensor_operation/gpu/grid/gridwise_elementwise.hpp"
    ...
    : public DeviceElementwise<InDataTypeTuple, OutDataTypeTuple, ElementwiseOperation, NumDim>
{
    ...
    struct Invoker : public BaseInvoker
    {
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            auto in_grid_desc_tuple = generate_tuple(
                [&](auto) {
                    return MakeDescriptor(arg.lengths_,
                                          arg.inStridesArray_[0],
                                          arg.outStridesArray_[0],
                                          arg.inStridesArray_[0]);
                },
                Number<NumInput>{});
            ...
            const bool in_out_same_vector_dim = GetLowestStrideDim(arg.inStridesArray_[0]) ==
                                                GetLowestStrideDim(arg.outStridesArray_[0]);
